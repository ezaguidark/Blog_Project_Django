...
SECRET_KEY = 'django-insecure-&g-qyf0n%!)-l-bdq_mlo8vkz@jg9f_0cuqq_pm#38$s1f!7x('
...
# Configuracion para media files, en este caso al subir imagenes
MEDIA_ROOT = '/media/'
...
# Default URL despues de Loggearse
